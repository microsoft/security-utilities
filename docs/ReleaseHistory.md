...
- NEW: Add `Detection.FormattedMessage` extension method that returns user-facing strings such as `'…444444' is a NuGet API key. The correlating id for this detection is 3wsjgo3hBjSPHdIc2Td1.`.
