...
namespace Microsoft.Security.Utilities
{
    public class FormalGuid : RegexPattern
    {
        public FormalGuid()
        {
            ...
            // This pattern encodes a more formal definition of a GUID compared to what might colloquially be thought of as a GUID.
            //
            // Specifically, this pattern ensures there's a 1-5 version identifier in the 3rd block and that the 4th block is constrained to the GUID variant.
        ...
        {
            // Office 365 SharePoint Online App Id - https://learn.microsoft.com/en-us/troubleshoot/entra/entra-id/governance/verify-first-party-apps-sign-in
