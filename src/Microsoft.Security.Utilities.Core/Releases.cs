...
/// <summary>
/// The version numbers of the Microsoft.Security.Utilities library releases. 
/// </summary>
/// <remarks>
/// Prior to version 1.4.15, we did not properly maintain change tracking in our
/// release history and we have not back-filled release notes for all code
/// changes. We have added an explicit release version for every historical
/// version where a rule was introduced. And so we have release here for version
/// 1.4.11 (because SEC101/AadClientAppLegacyCredentials was added in this
/// version) but we do not have an entry for 1.4.14 (because no new rules were
