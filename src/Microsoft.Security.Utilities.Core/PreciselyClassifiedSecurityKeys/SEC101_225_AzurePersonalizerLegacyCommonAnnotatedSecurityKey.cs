...
{
    public AzurePersonalizerLegacyCommonAnnotatedSecurityKey() : base()
    {
        Id = "SEC101/225";
    ...
    protected override AzureCognitiveServices AzureCognitiveService => AzureCognitiveServices.AzurePersonalizer;
}