...
{
    public AzureImmersiveReaderLegacyCommonAnnotatedSecurityKey() : base()
    {
        Id = "SEC101/219";
    ...
    protected override AzureCognitiveServices AzureCognitiveService => AzureCognitiveServices.AzureImmersiveReader;
}