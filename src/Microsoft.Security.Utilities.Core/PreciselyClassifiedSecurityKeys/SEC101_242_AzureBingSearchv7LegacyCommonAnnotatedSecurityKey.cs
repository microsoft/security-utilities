...
{
    public AzureBingSearchv7LegacyCommonAnnotatedSecurityKey() : base()
    {
        Id = "SEC101/242";
    ...
    protected override AzureCognitiveServices AzureCognitiveService => AzureCognitiveServices.AzureBingSearchv7;
}