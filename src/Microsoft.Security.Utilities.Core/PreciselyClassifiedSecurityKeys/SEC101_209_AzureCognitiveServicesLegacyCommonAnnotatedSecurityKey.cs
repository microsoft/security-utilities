...
{
    public AzureCognitiveServicesLegacyCommonAnnotatedSecurityKey() : base()
    {
        Id = "SEC101/209";
    ...
    protected override AzureCognitiveServices AzureCognitiveService => AzureCognitiveServices.AzureCognitiveServices;
}