...
{
    public AzureAnomalyDetectorLegacyCommonAnnotatedSecurityKey() : base()
    {
        Id = "SEC101/208";
    ...
    protected override AzureCognitiveServices AzureCognitiveService => AzureCognitiveServices.AzureAnomalyDetector;
}