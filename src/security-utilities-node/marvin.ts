...
export class Marvin {
  public static ComputeHash(input: Uint8Array, seed: bigint): bigint {
    ...
    // FIXME
    if (input.length >= 4) {
      const uData: Uint32Array = new Uint32Array(input.buffer.slice(0, input.length - input.length % 4));
      ...
      // JS: p0: 2412438674, p1: 2380923583
      // p0: 2412438674, p1: 2380923583
  ...
  private static block(rp0: Uint32, rp1: Uint32): [Uint32, Uint32] {
    let p0: Uint32 = rp0;
    let p1: Uint32 = rp1;
    // GOOD: rp0: 1298920984, rp1: 3577534926

    p1 = p1.XOR(p0);
    // YAY!: EXPECTED IN C#: p0: 1298920984, p1: 2555850710
    p0 = Marvin.rotate(p0, 20);
    // YAY! p0: 1636095679, p1: 2555850710

    p0 = p0.ADD(p1);
    // EXPECT: p0: 4191946389, p1: 2555850710
    p1 = Marvin.rotate(p1, 9);
    // EXPECT: p0: 4191946389, p1: 2925505840
