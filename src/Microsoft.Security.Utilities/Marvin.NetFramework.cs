...
#pragma warning disable S109    // Assign this magic number to a variable or constant.#pragma warning disable S907    // Remove this use of 'goto'.
...
/// based on the .NET 4.5 compatibility constraint to remove use of ReadOnlySpan.
///
...
internal static class Marvin
{
    ...
    public static long ComputeHash(byte[] data, ulong seed, int offset, int length)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(length), "Offset + length exceeds data size.");
        }
