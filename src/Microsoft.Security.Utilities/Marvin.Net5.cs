...
{
    /// <summary>
    /// This version of Marvin was extracted from the following source location.
    ...
    public static class Marvin
    {
        ...
        DoFinalPartialRead:
            ...
            uint partialResult = Unsafe.ReadUnaligned<uint>(ref Unsafe.Add(ref Unsafe.AddByteOffset(ref data, new IntPtr(count & 7)), -4));
        ...
        InputTooSmallToEnterMainLoop:
            ...
            if ((count & 0b_0001) != 0)
            {
                ...
                partialResult = Unsafe.AddByteOffset(ref data, new IntPtr(count & 2));
